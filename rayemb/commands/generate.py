...
from rayemb.utils import load, get_random_offset, Transforms, sample_grid_from_mask, setup_logger
...
@click.option('--type', type=click.Choice(['ctpelvic1k', 'deepfluoro'], case_sensitive=False), default='deepfluoro', help='Type of dataset')
